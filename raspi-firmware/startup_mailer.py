...
def connect_type(word_list):
    """ This function takes a list of words, then, depeding which key word, returns the corresponding internet connection type as a string. ie) 'ethernet'.
    """
...
# Account Information
to = 'bqiu@andrew.cmu.edu' # Email to send to.
gmail_user = 'bensonRPiMailer@gmail.com' # Email to send from. (MUST BE GMAIL)
gmail_password = 'benson549' # Gmail password.

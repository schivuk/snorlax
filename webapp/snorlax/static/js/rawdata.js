...
setTimeout(fetchNewData, 1);

function fetchNewData() {
	console.log("data.datasets[0].data[5]: " + data.datasets[0].data[5]);
	$.ajax({
		    url: "/getLatestReading",
		    method: 'GET',
		    dataType : "json",
		    async: true,
		    timeout: 5000,
		    success: function(response) {
		    	console.log("Got ajax response for chart: " + response)
		    	...
		    	for(var i=0; i<veloVals.length; i++) {
                    ...
                    console.log("Set value " + i + ": " + newChart.datasets[0].bars[i].value);
		    	}
		    	newChart.update(); 
		    ...
		    error: function(jqXHR, textStatus, errorThrown) {
		    	console.log("AJAX Error occurred in chart" );
